...
prolog.assertz("cumple_condicion_b([X|Xs],E):- relacion(enfermedad(E), sintoma(X)), obtener_porcentaje([X|Xs],E,0,Porcentaje), Porcentaje >= 75, posee_significativa([X|Xs],0,E)")
...
listaC = list(prolog.query("cumple_condicion_b([tos,fiebre,'escalofrios','no muerte'],X)"))
