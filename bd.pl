...
Los tipos de medicamentos de alivio rapido son los siguientes:
    * Agonistas beta de accion rapida, tales como salbutamol (ProAir HFA, Ventolin HFA y otros) o levalbuterol (Xopenex).
      Los cuales deben inhalarse mediante una mascarilla o una boquilla, para situaciones de bajo riesgo.
...
Los tratamientos especificos dependen del tipo y la gravedad de la neumonia:
    * Antibioticos. Estos medicamentos se usan para el tratamiento de la neumonia bacteriana. Si los sintomas no
      mejoran, el medico puede recomendarte un antibiotico diferente.
    * Medicamentos para la tos. Estos medicamentos pueden usarse para calmar la tos a fin de que puedas descansar. 
      Se recomienda usar la dosis mas baja posible.
    * Antifebriles/analgesicos tales como la aspirina, el ibuprofeno (Advil, Motrin IB, otros) y el paracetamol.
    Estos deben usarse solo para para aliviar la fiebre y el malestar.
').
...
No hay cura para el resfriado comun. Los antibioticos no son utiles contra los virus del resfriado y no deben utilizarse a menos
que haya una infeccion bacteriana. El tratamiento esta dirigido a aliviar los signos y sintomas, este incluye el uso de:
...
Para los casos leves, la combinacion de un tratamiento casero y descanso puede ser suficiente. Para los sintomas
mas molestos, existen los siguientes medicamentos:

    * Aerosoles nasales salinos o una solucion casera de agua salada para enjuagar los irritantes de la nariz.

    * Aerosoles nasales con corticoesteroides para ayudan a prevenir y tratar la inflamacion asociada con algunos
    tipos de rinitis no alergica. Los posibles efectos secundarios incluyen sequedad nasal, sangrado nasal, dolores
    ...
    * Aerosol nasal anticolinergicos tal como antigoteo ipratropium (Atrovent). Los efectos secundarios pueden incluir 
    sangrado nasal y sequedad en el interior de la nariz.

    * Descongestivos como pseudoefedrina (Sudafed) y fenilefrina (Afrin). Estos ayudan a reducir la congestion nasal
    Los posibles efectos secundarios incluyen presion arterial alta, palpitaciones e inquietud.
').

tratamiento(enfermedad(amigdalitis),'
Si la amigdalitis esta provocada por una infeccion bacteriana, el medico recetara una serie de antibioticos, tal 
comar penicilina por via oral durante 10 dias.
...
Las paperas son provocadas por un virus, por lo cual los antibioticos no son efectivos. La mayoria de los casos
de paperas se curan sin complicaciones en unas pocas semanas.
Las personas con paperas normalmente ya no contagian y pueden regresar al trabajo o a la escuela alrededor de cinco 
dias luego de la aparicion de los signos y sintomas.
Pero puedes tomar algunas medidas para aliviar el dolor y las molestias y evitar que otros se infecten. Intenta lo siguiente:
    ...
    * Uso de como el paracetamol (por ejemplo, Tylenol), o un medicamento antiinflamatorio tal como ibuprofeno 
    (Advil, Motrin IB u otros), para aliviar los sintomas.
...
El herpes labial, por lo general, desaparece sin tratamiento en el plazo de una a cuatro semanas. Diversos tipos de 
medicamentos antivirales con receta pueden acelerar el proceso de curacion. Por ejemplo:
...
Algunos de estos productos vienen en forma de pildoras para tragar. Otros son cremas para aplicar en las aftas varias
veces por dia. En general, las pildoras funcionan mejor que las cremas. En el caso de infecciones muy graves, 
se pueden aplicar algunos medicamentos antivirales mediante una inyeccion.
').


tratamiento(enfermedad('sinusitis cronica'),'
Estos son algunos de los tratamientos contra la sinusitis cronica:
    * Corticoesteroides nasales tales como fluticasona, triamcinolona, budesonida, mometasona y beclometasona.
    Estos aerosoles nasales ayudan a prevenir y tratar la inflamacion.
    * La irrigacion nasal salina, con aerosoles o soluciones nasales, reduce el drenaje y elimina los irritantes y las
     alergias.
    * Corticosteroides orales o inyectables. Estos medicamentos se usan para aliviar la inflamacion de la sinusitis
     grave, especialmente si tambien tienes polipos nasales.
...
Muchos virus de la influenza se han vuelto resistentes a los efectos de una categoria de medicamentos antivirales, 
entre ellos amantadina y rimantadina (Flumadine). Las autoridades de salud publica recomiendan el uso de oseltamivir
(Tamiflu) o, en caso de no poder usarlo, zanamivir (Relenza). Se pueden tomar estos medicamentos en un plazo de dos
